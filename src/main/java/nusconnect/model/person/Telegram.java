...
public class Telegram {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Telegram handles must be at least 5 characters long, case-insensitive, and can only contain letters, numbers, underscores, and it should not be blank";
